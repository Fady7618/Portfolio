...
const Projects = () => {
  ...
  const projects = [
    ...
    },
    {
      ...
      technologies: ['Next','TypeScript', 'Tailwind CSS', 'GSAP', 'JavaScript'],
      github:'https://github.com/Fady7618/Photography-Portfolio',
      live: 'https://photography-one-beryl.vercel.app/',
      featured: true,
